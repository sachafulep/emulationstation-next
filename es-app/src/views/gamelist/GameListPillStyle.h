#pragma once
#ifndef ES_APP_VIEWS_GAMELIST_GAME_LIST_PILL_STYLE_H
#define ES_APP_VIEWS_GAMELIST_GAME_LIST_PILL_STYLE_H
...
// Owns the visual chrome specific to the game list's pill style (SystemViewStyle == "list"):
...
// battery/network pills) that replaces the standard help bar in this mode. Mirrors
// SystemViewListStyle for TextListComponent<FileData*> instead of TextListComponent<SystemData*>.
class GameListPillStyle
{
public:
	GameListPillStyle(Window* window);
	...
	void configure(TextListComponent<FileData*>* textList, const Vector2f& screenSize, Vector2f& listPosition, Vector2f& listSize);
...
#endif // ES_APP_VIEWS_GAMELIST_GAME_LIST_PILL_STYLE_H
